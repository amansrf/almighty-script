...
# Python Script
cd C:\Users\roar\Documents\ROAR_RL_MENG_team\RLE2EMODEL\ROAR\ROAR_gym\

$e2emodel = Start-Process "C:\Users\roar\anaconda3\envs\ROAR_Major\python.exe" -ArgumentList "C:\Users\roar\Documents\ROAR_RL_MENG_team\RLE2EMODEL\ROAR\ROAR_gym\e2eModel.py" -PassThru
...
do {
    ...
    { 
        ...
        # Restart the Model
        $e2emodel = Start-Process "C:\Users\roar\anaconda3\envs\ROAR_Major\python.exe" -ArgumentList "C:\Users\roar\Documents\ROAR_RL_MENG_team\ROAR\ROAR_gym\e2eModel.py" -PassThru
        $e2emodel = $e2emodel | Get-Process
    }
    else{ 
        "e2emodel Running"
